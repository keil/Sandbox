...
benchmarks.push(base_dir + 'typescript.js');
benchmarks.push([base_dir + 'typescript-input.js', base_dir + 'typescript-compiler.js']);
...
function makeBenchmark(benchmark) {
  ...
  var str = "(function() { " + basestr + benchmarkstr + runstr + "})";
  var fun = eval(str);
  return fun;
}
